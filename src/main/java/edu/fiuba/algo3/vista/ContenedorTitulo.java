...
public class ContenedorTitulo extends HBox {
    ...
    public ContenedorTitulo() {
        ...
        this.nombreJugador.setStyle("-fx-font: 24 italics; -fx-text-fill: #BAB86C; -fx-alignment: center");
        this.numeroRonda = new Label();
        this.numeroRonda.setText("(Ronda)");
        this.numeroRonda.setStyle("-fx-font: 24 italics; -fx-text-fill: #BAB86C; -fx-alignment: center");
        this.setSpacing(5);
